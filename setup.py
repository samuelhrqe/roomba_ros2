...
setup(
    ...
    data_files=[
        ...
        ('share/' + package_name + '/kinect_node/config/kinect_calibration', 
            ['config/kinect_calibration/calibration_depth.yaml', 
             'config/kinect_calibration/calibration_rgb.yaml']),
        (os.path.join('share', package_name, 'launch'), glob('launch/*')),
        ('share/' + package_name + '/yolo_node/models', ['yolo_node/models/yolo11n.pt',]),
    ],
